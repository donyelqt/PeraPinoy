  ...
  return (
    <nav className='h-screen p-4 border bg-white shadow-md text-orange '>
      ...
      <div className='fixed bottom-5 mt-10 p-12 flex gap-1
          items-center'>
        <span className='text-primary rounded-3xl mb-4 text-sm font-bold bg-blue-950 p-2 flex items-center justify-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
