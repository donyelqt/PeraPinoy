    ...
    return (
        <nav className="bg-transparent dark:bg-gray-800 dark:border-gray-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className={`fixed top-0 left-0 w-[70%] h-full bg-gray-900 bg-opacity-95 z-50 ${isOpen ? 'block' : 'hidden'} md:hidden lg:hidden`} id="navbar-hamburger">
                    <nav className='h-full p-4 text-blue-600'>
                        <div className='p-2 pb-2 flex justify-between items-center'>
                            ...
                            >
                                <XIcon size={30} className='hover:text-red-600' />
                            </button>
                        </div>
                        <div className='mt-5'>
                            {menuList.map((menu) => (
