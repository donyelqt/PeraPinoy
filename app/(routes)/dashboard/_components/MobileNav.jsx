            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className={`fixed top-0 left-0 w-[70%] h-full bg-gray-900 bg-opacity-95 z-50 ${isOpen ? 'block' : 'hidden'} lg:hidden`} id="navbar-hamburger">
                    <nav className='h-full p-4 text-blue-600'>
                        ...
                        <div className='fixed bottom-5 p-12 flex gap-1items-center'>
                            <span className='text-tertiary rounded-3xl mb-4 text-sm font-bold bg-blue-950 p-2 flex items-center justify-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
