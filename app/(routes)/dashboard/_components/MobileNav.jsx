                ...
                <div className={`fixed top-0 left-0 w-[70%] h-full bg-opacity-95 z-50 ${isOpen ? 'block' : 'hidden'} lg:hidden`} id="navbar-hamburger">
                    <nav className='h-full p-4 bg-white'>
                        ...
                        <div className='fixed bottom-1 p-12 flex gap-1 items-center'>
                            <span className='text-white rounded-3xl mb-3 text-sm font-bold bg-blue-950 p-2 flex items-center justify-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5">
