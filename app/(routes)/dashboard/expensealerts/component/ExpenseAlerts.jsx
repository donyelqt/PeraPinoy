      ...
      {alerts.map((alert) => (
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <div className="text-lg text-black font-semibold">{alert.type}</div>
              <div className="text-gray-400">{alert.dueDate}</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-xl text-orange font-bold">₱{alert.amount}</div>
            <button
              onClick={() => handleDeleteAlert(alert.id)}
              className="mt-2 py-2 p-2 text-sm font-medium rounded-md bg-secondary hover:bg-yellow-600 text-slate-300 flex items-center"
            >
