const RewardsSystem = () => {
    return (
      <div className="shadow-xl border rounded-3xl p-6">
        ...
        <button className="mt-4 bg-orange text-white py-2 px-4 rounded-3xl hover:bg-dark hover:text-orange">View Rewards</button>
        <button className="mt-4 flex justify-center bg-secondary text-white py-2 px-4 rounded-3xl hover:bg-dark hover:text-orange">View Leaderboards</button>
